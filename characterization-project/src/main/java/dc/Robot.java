...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    // create left motor
    WPI_VictorSPX leftMotor = setupWPI_VictorSPX(4, Sides.LEFT, false);

    ArrayList<SpeedController> leftMotors = new ArrayList<SpeedController>();
    leftMotors.add(setupWPI_VictorSPX(6, Sides.FOLLOWER, false));
    ...
    WPI_VictorSPX rightMotor = setupWPI_VictorSPX(5, Sides.RIGHT, false);
    ArrayList<SpeedController> rightMotors = new ArrayList<SpeedController>();
    rightMotors.add(setupWPI_VictorSPX(7, Sides.FOLLOWER, false));
